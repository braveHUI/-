...
namespace BraveMvc.ManagerControllers
{
    public class MilitaryVideosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MilitaryVideo_id,MilitaryVideoName,MilitaryVideoDecride,MilitaryVideo_Ways,ForumSection_id,MilitaryVideoTime,MilitaryVideoImg")] MilitaryVideo militaryVideo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MilitaryVideo_id,MilitaryVideoName,MilitaryVideoDecride,MilitaryVideo_Ways,ForumSection_id,MilitaryVideoTime,MilitaryVideoImg")] MilitaryVideo militaryVideo)
        {
            if (ModelState.IsValid)
            {
